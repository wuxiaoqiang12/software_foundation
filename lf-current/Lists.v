...
Fixpoint eqblist (l1 l2 : natlist) : bool :=
  ...
  | h :: t => if h =? (hd 0 l2) then eqblist t (tl l2)
            else false
 (* | h :: t => match (eqb h (hd 0 l2)) with
                    | true => eqblist t (tl l2)
                    | false => false
                    end*)
  end.
...
(* NO, because there are no basecase. *)
